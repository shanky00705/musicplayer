    ...
    <div className="w-full h-[100vh] bg-gradient-to-b from-black via-gray-900 to-black flex justify-start items-center flex-col pt-[20px] md:pt-[100px] gap-[30px] relative overflow-hidden">
      ...
      >
        <h1 className="text-white font-bold text-2xl md:text-3xl flex items-center justify-center gap-2">
          <GoHeartFill className="text-pink-500" />
          Liked Songs
        </h1>
        <p className="text-gray-400 text-sm md:text-base mt-1">
          {songs.length} {songs.length === 1 ? "song" : "songs"} liked
        </p>
      </motion.div>
      ...
      <AnimatePresence>
        {songs.length > 0 ? (
          ...
          >
            <GoHeartFill className="text-6xl text-pink-500 opacity-70" />
            <h2 className="text-lg md:text-xl font-semibold">No liked songs</h2>
            <p className="text-sm text-gray-400">
              Tap the ❤️ icon on songs to save them here
            </p>
          </motion.div>
        )}
      </AnimatePresence>
